...
#Top_Frames 
label = CTkLabel(app, text="STUDENT REGISTRATION", font=font, width=2, height=50, fg_color='#2A409A')
label.pack(fill=X)

# main_view
main_view = CTkFrame(master=app,  corner_radius=10)
...
search_container.pack(fill="x", pady= 30)
...
label2 = CTkLabel(app, font=font,text="", width=900, height=200, corner_radius=32, fg_color='#2A409A')
...
label3 = CTkLabel(app, font=font,text="", width=900, height=200, corner_radius=32, fg_color='#2A409A')
...
upload_button.place(x=1025, y=370)
...
# Coded with ❤️ by Zaila Analytics